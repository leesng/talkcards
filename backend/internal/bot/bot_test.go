...
func TestFollowSmartBombChance(t *testing.T) {
	...
	cases := []struct {
		...
		{"无分4x8内30%命中", bomb4x6, 0, 0.29, []int{6, 6, 6, 6}},
		{"无分4x8内30%未中", bomb4x6, 0, 0.30, nil},
		{"无分4x10仅5%", bomb4x10, 0, 0.06, nil},
		{"无分4x10 5%命中", bomb4x10, 0, 0.04, []int{10, 10, 10, 10}},
		{"无分5张仅5%", bomb5x, 0, 0.06, nil},
		{"无分6张必过", bomb6x, 0, 0.0, nil},
		{"无分王炸必过", king3, 0, 0.0, nil},
		{"有分49 5张50%未中", bomb5x, 49, 0.50, nil},
		{"有分49 5张50%命中", bomb5x, 49, 0.49, []int{10, 10, 10, 10, 10}},
		{"有分49 6张20%命中", bomb6x, 49, 0.19, []int{10, 10, 10, 10, 10, 10}},
		{"有分49 6张20%未中", bomb6x, 49, 0.20, nil},
		{"有分49 4张照出", bomb4x10, 49, 0.99, []int{10, 10, 10, 10}},
		{"有分50必压", bomb6x, 50, 0.99, []int{10, 10, 10, 10, 10, 10}},
	}
	for _, c := range cases {
